  ...
  putChar: function(c, args) {
    ...
    for (var i = 0; i < content.length; i += 2) {
      ...
      if (digit == " R") {
        ...
        var x = randomGaussian(digit[0].charCodeAt(0) - ordR, 0.175);
        var y = randomGaussian(digit[1].charCodeAt(0) - ordR, 0.175);
          P5.vertex(x, y);
        }
      }
      P5.endShape();
